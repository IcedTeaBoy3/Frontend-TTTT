...
import { PlusCircleFilled, ExportOutlined, ImportOutlined ,UploadOutlined ,EditOutlined } from '@ant-design/icons'
...
const Hospital = () => {
    ...
    const queryGetAllHospitals = useQuery({
        ...
        queryFn: () => HospitalService.getAllHospitals(pagination.current, pagination.pageSize),
    ...
    const handleDeleteManyHospitals = () => {
        mutationDeleteManyHospital.mutate({ids:selectedRowKeys}, {
            onSettled: () => {
                queryGetAllHospitals.refetch()
            }
        })
    ...
    return (
        <>
            ...
            <LoadingComponent isLoading={isPendingAdd} >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Input.TextArea rows={2} placeholder="Nhập địa chỉ tại đây" />
                        </Form.Item>
                        <Form.Item
                            label="Số điện thoại"
                            name="phone"
            ...
            >
                <LoadingComponent isLoading={isPendingUpdate}>
                    ...
                    >
                        ...
                        >
                            <Input.TextArea name='address' rows={2} placeholder="Nhập địa chỉ chi tiết tại đây..." />
                        </Form.Item>
                        <Form.Item
                            label="Số điện thoại"
                            name="phone"
            ...
            >
                ...
                <p>Bạn có chắc chắn muốn <strong>xóa</strong> bệnh viện này không?</p>
                </LoadingComponent>
            </ModalComponent>
        </>
    )
