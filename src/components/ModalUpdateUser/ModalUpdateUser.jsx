    ...
    useEffect(() => {
        if (patient) {
            formUpdate.setFieldsValue({
                ...
                specific_address: patient?.address ? patient?.address.split(',')[0] : '',
                district: patient?.address ? patient?.address.split(',')[1] : '',
                province: patient?.address ? patient?.address.split(',')[2] : '',
                ward: patient?.address ? patient?.address.split(',')[3] : '',
